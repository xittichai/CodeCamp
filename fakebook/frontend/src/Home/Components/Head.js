...
export default class Head extends Component {
    render() {
        return (
            <Helmet>
                <html id="facebook" lang="en" dir="ltr" class="__fb-dark-mode" />

                <link rel="shortcut icon" href="https://static.xx.fbcdn.net/rsrc.php/yD/r/d4ZIVX-5C-b.ico?_nc_eui2=AeHVkj63fOd0ytknW0RN9Ri2aBWfmC2eGbdoFZ-YLZ4Zt47KPyDU6VK_iHjfaYJCbXpJRkOws8esKx8CPZwa84Lc" />
                <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=2" />

                <link type="text/css" rel="stylesheet" href="https://static.xx.fbcdn.net/rsrc.php/v3/yg/l/0,cross/MwzKtZBrY3EdmpWPzsrC2YG88zRykp4L07HCWNxfHdisvdONWNN--9SJs77mbizxiUP7Kfn3DgaieD2FRGYkDifPVSm-2WJO519MfVktazJdAMqDgsSIr2J7fTTNdJ-iU1s1.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeEZ6CfSyHp6ObGuck2Jdz51NYF6uEboRco1gXq4RuhFykMBi4L4atvHQj-6SV2LA9_m3Dc2K2tXLfx7YiEYwtEG" data-bootloader-hash="nK+kp" crossorigin="anonymous" data-p=":5,3154,6512,3152,305,433,2084,3138,23,6566,5423,9338" />

                <title>Fakebook</title>

                <style type="text/css" data-styled="true"></style>
                <link href="data:text/css; charset=utf-8,._1-s8{pointer-events:none;z-index:1}._1zvy{height:72px;left:50%;opacity:0;position:absolute;top:50%;transform:translate(-50%, -50%);transform-style:preserve-3d;transition:opacity .8s cubic-bezier(.23, 1, .32, 1);width:72px}._2dz7._1zvy{opacity:1;transition-property:none}._3s0i._1zvy{opacity:1}._2dz7 div{animation-delay:.3s;animation-duration:2s}._4z8s div{animation-iteration-count:infinite}._4z8p div{animation-play-state:paused}._4z8q{background:rgba(0, 0, 0, .5);border-radius:50%;border-width:0;height:72px;left:50%;opacity:1;position:absolute;top:50%;transform:translateZ(0) translate(-50%, -50%);width:72px}._4z8r{border:2px solid %23fff;border-radius:50%;height:60px;left:4px;position:absolute;top:4px;transform:rotate(0deg);transform-style:preserve-3d;width:60px}@keyframes gyroInner{25%{transform:rotate(4deg)}56%{transform:rotate(-1deg)}92%{transform:rotate(0deg)}}._2dz7 ._4z8r{animation-name:gyroInner}._4z8t{background:none;border:1px solid %23ccd0d5;border-radius:50%;height:58px;left:50%;position:absolute;transform:translateX(-50%);width:29px;will-change:width}@keyframes gyroMeridian{0%{width:29px}4%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:29px}33%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}56%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:59px}79%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}96%{width:29px}100%{width:29px}}._2dz7 ._4z8t{animation-name:gyroMeridian;animation-timing-function:linear}._4z8u{background:rgba(255, 255, 255, .2);border:1px solid %23ccd0d5;border-radius:50%;height:29px;position:absolute;top:50%;transform:translateY(-50%);width:58px;will-change:height}@keyframes gyroEquator{0%{height:29px}25%{height:39px}56%{height:11px}92%{height:29px}100%{height:29px}}._2dz7 ._4z8u{animation-name:gyroEquator}._4z8v{border-radius:50%;border-width:0;height:60px;left:50%;overflow:hidden;position:absolute;top:6px;transform:translateX(-50%);white-space:nowrap;width:29px;will-change:height}._4z8w{border-width:0;color:%23fff;font:14px sans-serif;height:60px;left:50%;line-height:60px;position:absolute;text-align:center;transform:translateX(-50%);width:29px}@keyframes gyroTextShell{0%{width:29px}4%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:29px}33%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}56%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:0}79%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}96%{width:29px}100%{width:29px}}._2dz7 ._4z8v{animation-name:gyroTextShell;animation-timing-function:linear}@keyframes mousemove{21%{transform:translate(0px, 2px)}56%{transform:translate(10px, 1px)}98%{transform:translate(0px, 0)}}@keyframes mouseinner{8%{transform:translate(0px, 0)}38%{transform:translate(1px, 4px)}62%{transform:translate(1px, 4px)}90%{transform:translate(0px, 0)}}@keyframes mouserotate{8%{transform:translate(0px, 16px) rotate(0deg) translate(0px, -16px)}27%{transform:translate(0px, 16px) rotate(-6deg) translate(0px, -16px)}57%{transform:translate(0px, 16px) rotate(9.5deg) translate(0px, -16px)}}._2660{bottom:12px;left:50%;opacity:0;pointer-events:none;position:absolute;transform:translate(-50%, 0%);transition:opacity .8s cubic-bezier(.23, 1, .32, 1)}._2dz7._2660{opacity:1}._2661{bottom:24px;height:32px;left:50%;margin-left:-9px;position:absolute;transition:opacity .8s cubic-bezier(.23, 1, .32, 1);width:18px}._2dz7._2661{animation-duration:2s;animation-iteration-count:infinite;animation-name:mousemove;height:32px;width:18px}._2dz7._2663{animation-duration:2s;animation-iteration-count:infinite;animation-name:mouserotate}._2dz7._2664{animation-duration:2s;animation-iteration-count:infinite;animation-name:mouseinner}._266m{background-color:%23fff;border-radius:0 0 9px 9px;height:23px;position:absolute;width:18px}._15nj{background-color:rgba(0, 0, 0, .2);border-radius:11px;height:36px;position:absolute;transform:translate(-2px, -11px);width:22px}._2662{color:%23fff;font-size:12px;font-weight:bold;margin:2px;text-align:center;text-shadow:0 1px 2px rgba(0, 0, 0, .5);white-space:nowrap}@keyframes leftclick{10%{opacity:.6}56%{opacity:.6}66%{opacity:1.0}}._2665{border-radius:9px 9px 0 0;height:9px;overflow:hidden;position:absolute;transform:translate(0px, -9px);width:18px}._2666{background-color:%23fff;height:7px;position:absolute;width:8px}._2dz7._2666{animation-duration:2s;animation-iteration-count:infinite;animation-name:leftclick}._2667{background-color:%23fff;height:7px;position:absolute;transform:translate(11px, 0);width:7px}._236i{bottom:12px;left:50%;opacity:0;pointer-events:none;position:absolute;transform:translate(-50%, 0%);transition:opacity .8s cubic-bezier(.23, 1, .32, 1)}._2k2g{color:%23fff;font-size:12px;font-weight:bold;margin:2px;text-align:center;text-shadow:0 1px 2px rgba(0, 0, 0, .5);white-space:nowrap}._2dz7._236i{opacity:1}
        .sp_RZ9AvWQKNjp_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yX/r/L-HRc_6Fwxs.png);background-size:14px 28px;background-repeat:no-repeat;display:inline-block;height:12px;width:12px}.sp_RZ9AvWQKNjp_1_5x.sx_a75086{background-position:0 0}.sp_RZ9AvWQKNjp_1_5x.sx_1877bd{background-position:0 -14px}
        .sp_AVy-xtQ87KV_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yo/r/UrTvdxr6X-w.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_AVy-xtQ87KV_1_5x.sx_948f23{background-position:0 0}.sp_AVy-xtQ87KV_1_5x.sx_d17efc{background-position:0 -22px}
        .sp_vBK30-EzH7w_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yE/r/u0Vmh4CEWSw.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_vBK30-EzH7w_1_5x.sx_c9494a{background-position:0 0}.sp_vBK30-EzH7w_1_5x.sx_59b20a{background-position:0 -22px}
        .sp_lodG-Pg7yHu_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/vuDLv-keNUz.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_lodG-Pg7yHu_1_5x.sx_96fda1{background-position:0 0}.sp_lodG-Pg7yHu_1_5x.sx_687721{background-position:0 -22px}%23bootloader_EFYLG{height:42px;}.bootloader_EFYLG{display:block!important;}" rel="preload" as="style" />
                <link rel="stylesheet" type="text/css" href="data:text/css; charset=utf-8,._1-s8{pointer-events:none;z-index:1}._1zvy{height:72px;left:50%;opacity:0;position:absolute;top:50%;transform:translate(-50%, -50%);transform-style:preserve-3d;transition:opacity .8s cubic-bezier(.23, 1, .32, 1);width:72px}._2dz7._1zvy{opacity:1;transition-property:none}._3s0i._1zvy{opacity:1}._2dz7 div{animation-delay:.3s;animation-duration:2s}._4z8s div{animation-iteration-count:infinite}._4z8p div{animation-play-state:paused}._4z8q{background:rgba(0, 0, 0, .5);border-radius:50%;border-width:0;height:72px;left:50%;opacity:1;position:absolute;top:50%;transform:translateZ(0) translate(-50%, -50%);width:72px}._4z8r{border:2px solid %23fff;border-radius:50%;height:60px;left:4px;position:absolute;top:4px;transform:rotate(0deg);transform-style:preserve-3d;width:60px}@keyframes gyroInner{25%{transform:rotate(4deg)}56%{transform:rotate(-1deg)}92%{transform:rotate(0deg)}}._2dz7 ._4z8r{animation-name:gyroInner}._4z8t{background:none;border:1px solid %23ccd0d5;border-radius:50%;height:58px;left:50%;position:absolute;transform:translateX(-50%);width:29px;will-change:width}@keyframes gyroMeridian{0%{width:29px}4%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:29px}33%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}56%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:59px}79%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}96%{width:29px}100%{width:29px}}._2dz7 ._4z8t{animation-name:gyroMeridian;animation-timing-function:linear}._4z8u{background:rgba(255, 255, 255, .2);border:1px solid %23ccd0d5;border-radius:50%;height:29px;position:absolute;top:50%;transform:translateY(-50%);width:58px;will-change:height}@keyframes gyroEquator{0%{height:29px}25%{height:39px}56%{height:11px}92%{height:29px}100%{height:29px}}._2dz7 ._4z8u{animation-name:gyroEquator}._4z8v{border-radius:50%;border-width:0;height:60px;left:50%;overflow:hidden;position:absolute;top:6px;transform:translateX(-50%);white-space:nowrap;width:29px;will-change:height}._4z8w{border-width:0;color:%23fff;font:14px sans-serif;height:60px;left:50%;line-height:60px;position:absolute;text-align:center;transform:translateX(-50%);width:29px}@keyframes gyroTextShell{0%{width:29px}4%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:29px}33%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}56%{animation-timing-function:cubic-bezier(.470, .000, .745, .715);width:0}79%{animation-timing-function:cubic-bezier(.390, .575, .565, 1.000);width:0}96%{width:29px}100%{width:29px}}._2dz7 ._4z8v{animation-name:gyroTextShell;animation-timing-function:linear}@keyframes mousemove{21%{transform:translate(0px, 2px)}56%{transform:translate(10px, 1px)}98%{transform:translate(0px, 0)}}@keyframes mouseinner{8%{transform:translate(0px, 0)}38%{transform:translate(1px, 4px)}62%{transform:translate(1px, 4px)}90%{transform:translate(0px, 0)}}@keyframes mouserotate{8%{transform:translate(0px, 16px) rotate(0deg) translate(0px, -16px)}27%{transform:translate(0px, 16px) rotate(-6deg) translate(0px, -16px)}57%{transform:translate(0px, 16px) rotate(9.5deg) translate(0px, -16px)}}._2660{bottom:12px;left:50%;opacity:0;pointer-events:none;position:absolute;transform:translate(-50%, 0%);transition:opacity .8s cubic-bezier(.23, 1, .32, 1)}._2dz7._2660{opacity:1}._2661{bottom:24px;height:32px;left:50%;margin-left:-9px;position:absolute;transition:opacity .8s cubic-bezier(.23, 1, .32, 1);width:18px}._2dz7._2661{animation-duration:2s;animation-iteration-count:infinite;animation-name:mousemove;height:32px;width:18px}._2dz7._2663{animation-duration:2s;animation-iteration-count:infinite;animation-name:mouserotate}._2dz7._2664{animation-duration:2s;animation-iteration-count:infinite;animation-name:mouseinner}._266m{background-color:%23fff;border-radius:0 0 9px 9px;height:23px;position:absolute;width:18px}._15nj{background-color:rgba(0, 0, 0, .2);border-radius:11px;height:36px;position:absolute;transform:translate(-2px, -11px);width:22px}._2662{color:%23fff;font-size:12px;font-weight:bold;margin:2px;text-align:center;text-shadow:0 1px 2px rgba(0, 0, 0, .5);white-space:nowrap}@keyframes leftclick{10%{opacity:.6}56%{opacity:.6}66%{opacity:1.0}}._2665{border-radius:9px 9px 0 0;height:9px;overflow:hidden;position:absolute;transform:translate(0px, -9px);width:18px}._2666{background-color:%23fff;height:7px;position:absolute;width:8px}._2dz7._2666{animation-duration:2s;animation-iteration-count:infinite;animation-name:leftclick}._2667{background-color:%23fff;height:7px;position:absolute;transform:translate(11px, 0);width:7px}._236i{bottom:12px;left:50%;opacity:0;pointer-events:none;position:absolute;transform:translate(-50%, 0%);transition:opacity .8s cubic-bezier(.23, 1, .32, 1)}._2k2g{color:%23fff;font-size:12px;font-weight:bold;margin:2px;text-align:center;text-shadow:0 1px 2px rgba(0, 0, 0, .5);white-space:nowrap}._2dz7._236i{opacity:1}
        .sp_RZ9AvWQKNjp_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yX/r/L-HRc_6Fwxs.png);background-size:14px 28px;background-repeat:no-repeat;display:inline-block;height:12px;width:12px}.sp_RZ9AvWQKNjp_1_5x.sx_a75086{background-position:0 0}.sp_RZ9AvWQKNjp_1_5x.sx_1877bd{background-position:0 -14px}
        .sp_AVy-xtQ87KV_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yo/r/UrTvdxr6X-w.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_AVy-xtQ87KV_1_5x.sx_948f23{background-position:0 0}.sp_AVy-xtQ87KV_1_5x.sx_d17efc{background-position:0 -22px}
        .sp_vBK30-EzH7w_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yE/r/u0Vmh4CEWSw.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_vBK30-EzH7w_1_5x.sx_c9494a{background-position:0 0}.sp_vBK30-EzH7w_1_5x.sx_59b20a{background-position:0 -22px}
        .sp_lodG-Pg7yHu_1_5x{background-image:url(https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/vuDLv-keNUz.png);background-size:22px 44px;background-repeat:no-repeat;display:inline-block;height:20px;width:20px}.sp_lodG-Pg7yHu_1_5x.sx_96fda1{background-position:0 0}.sp_lodG-Pg7yHu_1_5x.sx_687721{background-position:0 -22px}%23bootloader_EFYLG{height:42px;}.bootloader_EFYLG{display:block!important;}" />
                <link href="https://static.xx.fbcdn.net/rsrc.php/v3/yT/l/0,cross/p20rm6kTY_Nun9wfG_Wls3PrnTly3I5MWYdGhw_JWYtgeYhxg1PIHnC.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeGVBzry_2BPOrlkyQLayfS5_i1JrSeqsNf-LUmtJ6qw14eGl24QmAlhEztNrP59L1i6yJVjPY6Px4R-7Zc__K3j" rel="preload" as="style" crossorigin="anonymous" />
                <link rel="stylesheet" type="text/css" href="https://static.xx.fbcdn.net/rsrc.php/v3/yT/l/0,cross/p20rm6kTY_Nun9wfG_Wls3PrnTly3I5MWYdGhw_JWYtgeYhxg1PIHnC.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeGVBzry_2BPOrlkyQLayfS5_i1JrSeqsNf-LUmtJ6qw14eGl24QmAlhEztNrP59L1i6yJVjPY6Px4R-7Zc__K3j" crossorigin="anonymous" />
                ...
                <style type="text/css">{`
                    ...
                    .liner-share-menu .liner-share-method:hover {
                        background-color: var(--grayscale1-100) !important;
                    }
                    ...
                    .liner-mobile-comment-box .liner-comment-comment-container .liner-comment-textarea::-webkit-input-placeholder {
                        /* WebKit, Blink, Edge */
                        font-family: -apple-system, BlinkMacSystemFont, 'Noto Sans KR', 'Noto Sans JP', 'Noto Sans SC', sans-serif !important;
                        font-size: 16px !important;
                        line-height: 24px !important;
                    ...
                    .liner-mobile-comment-box .liner-comment-comment-container .liner-comment-textarea:-moz-placeholder {
                    ...
                    .liner-mobile-comment-box .liner-comment-comment-container .liner-comment-textarea:-ms-input-placeholder {
                    ...
                    .liner-mobile-comment-box .liner-comment-comment-container .liner-comment-textarea::placeholder {
                ...
                `}</style>
                <link href="https://static.xx.fbcdn.net/rsrc.php/v3/yk/l/0,cross/rUTHQRJZVYY.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeHnchPPOAe8kMofkxmx-X64BPSEcI7kxFkE9IRwjuTEWXsFNFqmMX8WFqiVPiUxLAlounr1xWVtRvs1PaN_Qbye" rel="preload" as="style" crossorigin="anonymous" />
                <link rel="stylesheet" type="text/css" href="https://static.xx.fbcdn.net/rsrc.php/v3/yk/l/0,cross/rUTHQRJZVYY.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeHnchPPOAe8kMofkxmx-X64BPSEcI7kxFkE9IRwjuTEWXsFNFqmMX8WFqiVPiUxLAlounr1xWVtRvs1PaN_Qbye" crossorigin="anonymous" />
                <link href="https://static.xx.fbcdn.net/rsrc.php/v3/yb/l/0,cross/EiUmLvt0PND.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeFWPvkUer-sjtkme-rocTRzF2teaucWMgMXa15q5xYyAzr3CcVILC23lho6zLSE6DdnGDhDvhP1tDLKXzEcYbKJ" rel="preload" as="style" crossorigin="anonymous" />
                <link rel="stylesheet" type="text/css" href="https://static.xx.fbcdn.net/rsrc.php/v3/yb/l/0,cross/EiUmLvt0PND.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeFWPvkUer-sjtkme-rocTRzF2teaucWMgMXa15q5xYyAzr3CcVILC23lho6zLSE6DdnGDhDvhP1tDLKXzEcYbKJ" crossorigin="anonymous" />
                <link href="https://static.xx.fbcdn.net/rsrc.php/v3/yj/l/0,cross/JvTT2DyYDy9.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeGaPac6ovZWo8aKkQkYqXhhh45_LZeG88OHjn8tl4bzw8VYwqafVbfyjKBpsWLe0kKKA0I957oJCypDKWR2rjTQ" rel="preload" as="style" crossorigin="anonymous" />
                <link rel="stylesheet" type="text/css" href="https://static.xx.fbcdn.net/rsrc.php/v3/yj/l/0,cross/JvTT2DyYDy9.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeGaPac6ovZWo8aKkQkYqXhhh45_LZeG88OHjn8tl4bzw8VYwqafVbfyjKBpsWLe0kKKA0I957oJCypDKWR2rjTQ" crossorigin="anonymous" />
                <link href="https://static.xx.fbcdn.net/rsrc.php/v3/y9/l/0,cross/MLHIGW_V1SkDEOuBKgsnsiaafbE1s2AnzPgxW3Kjv-ytDVy29HyQ5g0sSfZCY82RHQjvb21z7zYVIK38EbRZvFsvFqj4ecmX8rG.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeFUXCFOxSYemKD_d5Pntz3wb_HpAiEHhqdv8ekCIQeGp6bv4expsX349LKRfcQ08lVlsNiYMqigGClEsY7OsSw6" rel="preload" as="style" crossorigin="anonymous" />
                <link rel="stylesheet" type="text/css" href="https://static.xx.fbcdn.net/rsrc.php/v3/y9/l/0,cross/MLHIGW_V1SkDEOuBKgsnsiaafbE1s2AnzPgxW3Kjv-ytDVy29HyQ5g0sSfZCY82RHQjvb21z7zYVIK38EbRZvFsvFqj4ecmX8rG.css?_nc_x=WGDP9Oq1xE6&amp;_nc_eui2=AeFUXCFOxSYemKD_d5Pntz3wb_HpAiEHhqdv8ekCIQeGp6bv4expsX349LKRfcQ08lVlsNiYMqigGClEsY7OsSw6" crossorigin="anonymous" />

                <body class="_6s5d _71pn _-kb segoe" cz-shortcut-listen="true" />
            </Helmet>
        );
    };
};  